...
class TestArithmetic():
    ...
    def test_division(self, optimization_level, interpreter, debug_executable):
        output = run_test("tests/arithmetic/00.division/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_modulus(self, optimization_level, interpreter, debug_executable):
        output = run_test("tests/arithmetic/01.modulus/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_increment(self, optimization_level, interpreter, debug_executable):
        output = run_test("tests/arithmetic/02.increment/code.pl0", int(optimization_level), interpreter, debug_executable)
