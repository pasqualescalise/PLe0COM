...
class TestChainLoadStoreElimination():
    ...
    def test_chain_load_store_elimination(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/optimizations/chain_load_store_elimination/00.chain_load_store_elimination/code.pl0", int(optimization_level), interpreter, debug_executable)
