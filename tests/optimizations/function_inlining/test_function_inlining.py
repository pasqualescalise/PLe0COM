...
class TestFunctionInlining():
    ...
    def test_function_inlining(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/optimizations/function_inlining/00.function_inlining/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_inline_functions_in_main(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/optimizations/function_inlining/01.inline_functions_in_main/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_remove_inlined_functions(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/optimizations/function_inlining/02.remove_inlined_functions/code.pl0", int(optimization_level), interpreter, debug_executable)
