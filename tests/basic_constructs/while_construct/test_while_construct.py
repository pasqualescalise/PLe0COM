...
class TestWhileConstruct():
    ...
    def test_while(self, optimization_level, interpreter):
        output = get_test_output("tests/basic_constructs/while_construct/00.while/code.pl0", int(optimization_level), interpreter)
