...
class TestLexer():
    ...
    def test_lexer_keywords(self, optimization_level, interpreter, debug_executable):
        output = run_test("tests/lexer/00.lexer_keywords/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_keyword_strings(self, optimization_level, interpreter, debug_executable):
        output = run_test("tests/lexer/01.keyword_strings/code.pl0", int(optimization_level), interpreter, debug_executable)
