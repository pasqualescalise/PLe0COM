...
class TestCalls():
    ...
    def test_simple_procedure_with_arguments(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/procedure_calls/calls/00.simple_procedure_with_arguments/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_multiple_procedures_with_arguments(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/procedure_calls/calls/01.multiple_procedures_with_arguments/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_procedures_with_arguments_with_for(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/procedure_calls/calls/02.procedures_with_arguments_with_for/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_changed_datalayout(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/procedure_calls/calls/03.changed_datalayout/code.pl0", int(optimization_level), interpreter, debug_executable)
