...
class TestRecursion():
    ...
    def test_recursive_function(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/procedure_calls/recursion/00.recursive_function/code.pl0", int(optimization_level), interpreter, debug_executable)
    ...
    def test_recursive_nested_function(self, optimization_level, interpreter, debug_executable):
        output = get_test_output("tests/procedure_calls/recursion/01.recursive_nested_function/code.pl0", int(optimization_level), interpreter, debug_executable)
